...
ExampleLayer::ExampleLayer(float aspectRatio)
...
void ExampleLayer::OnUpdate(Viper::Timestep timestep)
{
	if (m_CameraOn)
	{
...
void ExampleLayer::OnEvent(Viper::Event& evnt)
{
...
bool ExampleLayer::OnKeyPressedEvent(Viper::KeyPressedEvent& evnt)
{
